...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler()]  # Remove file handler for streamlit
)
    ...
    def retrieve_and_summarize(self, query: str) -> str:
        ...
        try:
            ...
            template = '''You are an advanced Legal Research AI Assistant. Provide a comprehensive, structured legal analysis based on the context and query below:
                        ...
                        ### **Analysis Guidelines:** 1. **Examine the Context Thoroughly** → Extract key legal points. 
                            ...
                            7. **Provide a Structured Response:** - **Legal Summary:** (Brief overview) 
                                - **Key Legal Findings:** (Bullet points) 
                                    - **Relevant Laws/Precedents (if applicable):** - **Implications & Next Steps:** (Possible legal actions or considerations)   
                        '''
            template = template.format(context=context, query=query)
